...
export function HowEsimWorks() {
  return (
    <section className="container pt-10 md:pt-14 lg:pt-16 xl:pt-22 pb-14 lg:pb-20 xl:pb-28 text-center">
      <div className="max-w-3xl mx-auto">
        <p className="font-semibold mb-2 text-primary-pink">eSIM APP</p>
        <h2 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-semibold mb-3 md:mb-5 lg:mb-8 xl:mb-12">
          How Our eSIM Works?
        </h2>

        <div className="grid md:grid-cols-2 gap-5 md:gap-20 items-center text-left">
          <p className="text-[15px] md:text-lg xl:text-xl font-medium text-center text-gray-500 leading-relaxed">
