...
export default function Banner() {
  return (
    <section className="container pt-6">
      ...
      <div className="relative rounded-2xl overflow-hidden h-90 lg:h-105 flex items-center justify-center text-center">
        <Image
          src={bannerBg}
          alt="banner"
          fill
        ...
        <div className="relative z-10 px-6">
          <h1 className="text-white text-2xl lg:text-3xl xl:text-4xl font-semibold leading-tight">
