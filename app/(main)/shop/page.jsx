...
const ShopPage = () => {
  ...
  return (
    <section className="max-w-350 mx-auto px-5 mb-5 md:mb-8 lg:mb-12 xl:mb-20">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        {/* ======================
                FILTER SIDEBAR
            ====================== */}
        <div className="lg:sticky top-22 w-full lg:w-68 xl:w-72.5 bg-white p-5 rounded-2xl shadow-sm shrink-0">
        ...
        {/* ======================
                PRODUCTS GRID
            ====================== */}
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-y-6 gap-x-4 md:gap-x-5">
          {productLoading ? (
